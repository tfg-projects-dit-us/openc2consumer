...
/**
 * @author Isabel Román
 * Configura el canal gRPC y los stubs síncrono y asíncrono fuera del perfil test.
 * Lee velociraptor.host y velociraptor.port, con localhost:8001 por defecto.
 * El canal activo usa plaintext; las propiedades ssl, username y password
 * no se aplican. El bloque comentado conserva ejemplos anteriores de conexión.
 */
@Configuration
@Profile("!test")
